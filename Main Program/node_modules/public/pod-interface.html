...
<script>
    ...
    window.onload = function() {
        ...
        // // Example data that might come from the server
        // var exampleData = {
        //     temperatures: [10.0, 18.1, 19.4, 16.2],
        //     pressures: [120.1, 95.5]
        // };

        // // Update display with example data
        // updateSensorDisplays(exampleData);
